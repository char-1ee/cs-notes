...
1. [String concatenation with `String.format()`](./#string-concatenation-with-string.format)
2. [Build buffered IO streams](./#build-buffered-io-streams)
3. [Reduce loops by `Map`](./#reduce-loops-by-map)
4. [Close resources in-time](./#close-resources-in-time)
5. [Multithreading API calls](./#multithreading-api-calls)
6. [Lazy loading](./#lazy-loading)
7. [Initialize capacity for `Collections`](./#initialize-capacity-for-collections)``
8. [Replace synchronized methods with synchronized blocks](./#replace-synchronized-methods-with-synchronized-blocks)
9. [Pagination for big data](./#pagination-for-big-data)
10. [Avoid infinite loops](./#avoid-infinite-loops)
11. [Avoid logcat overflow](./#avoid-logcat-overflow)
