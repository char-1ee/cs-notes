---
description: How to access android database (SQLite) thread safe.
---

# Concurrent database access

This short article describes how to make access to your android database thread safe. Refer to the sample project [here](https://github.com/dmytrodanylyk/android-concurrent-database) and source article [here](https://github.com/dmytrodanylyk/dmytrodanylyk/blob/gh-pages/articles/Concurrent%20Database%20Access.md?plain=1).
